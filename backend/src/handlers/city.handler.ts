...
export class CityHandler {
  ...
  private static async removeCityByID(
    req: Request,
    res: Response,
  ): Promise<void> {
    try {
  ...
  private static async getAllCities(
    req: Request,
    res: Response,
  ): Promise<void> {
    try {
  ...
  private static async addCityAirport(
    req: Request,
    res: Response,
  ): Promise<void> {
    if (!checkValidation(req, res)) return;
  ...
  private static async removeCityAirport(
    req: Request,
    res: Response,
  ): Promise<void> {
    try {
  ...
  private static async updateAirport(
    req: Request,
    res: Response,
  ): Promise<void> {
    if (!checkValidation(req, res)) return;
