...
import { getMockFlight, mockAirports, mockBaggageRules, mockCities, mockCompanies } from "./mock/mock.data";
...
describe("company.service", () => {
	...
	describe("addCompany", () => {
		it("should add and return correctly", () => {
			...
			expect(company.baggage_rule.max_free_weight).toBe(brEntry.max_free_weight);
