...
<template>
	...
	<div class="text-center w-50">
		...
		<form class="mt-5" @submit.prevent="login_action()">
			...
			<div class="mt-3">
				<input type="text" class="form-control" name="login" placeholder="Логин" maxlength="256" v-model="form_data.login">
			</div>
			<div class="mt-3">
				<input type="password" class="form-control" name="password" placeholder="Пароль" maxlength="128" v-model="form_data.password">
			</div>
